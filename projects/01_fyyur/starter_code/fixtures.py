from app import db, Venue, Artist, Genre, Show
...
v1.genres = [genres[i] for i in [10, 15, 2, 5]]
...
v2.genres = [genres[i] for i in [2, 14, 7]]
...
v3.genres = [genres[i] for i in [14, 1, 9, 8]]
...
v4.genres = [genres[i] for i in [0,2,4,6,8,10,15]]
